...
const EditDocumentModal = (props: Props) => {
  ...
  const onEditDocument = (key: string, value: any) => {
    ...
    dispatch(companySelfVerificationActions.editDocument(updatedDocument as VerificationDocument));
  };
  ...
  const updateDocument = () => {
    ...
    dispatch(companySelfVerificationActions.updateDocument(editingDocument))
  ...
  const closeEditingDocument = () => {
    dispatch(companySelfVerificationActions.editDocument(undefined));
    dispatch(companySelfVerificationActions.changeEditDocumentModalState(false));
  };
